...
# Set up button event and run the main Tkinter loop
...
# Simulate data fetching, process it, and update the UI accordingly
def fetch_data(ui, date):
    try:
        time.sleep(2.5)  # Simulated delay for loading
...
# Extract and process relevant sleep data into a readable format
...
# Determine textual quality label based on sleep index
...
# Generate sleep advice string based on sleep index
